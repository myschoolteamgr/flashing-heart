...
> Άνοιγμα αυτής της σελίδας στο [https://myschoolteamgr.github.io/flashing-heart/](https://myschoolteamgr.github.io/flashing-heart/)
...
* αναζήτηση για **https://github.com/myschoolteamgr/flashing-heart** και εισαγωγή
...
* επικολλήστε **https://github.com/myschoolteamgr/flashing-heart** και κάντε κλικ στην εισαγωγή
